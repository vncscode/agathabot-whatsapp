...
const banner2 = cfonts.render((`Canal: https://youtube.com/@fy3448\nDesenvolvedor Oficial: @felipefrases.exe`), {
font: 'console',
align: 'center',
gradient: ['red', 'magenta']
});
 
const banner3 = cfonts.render((`AGATHA|2.0`), {
  font: 'block',
  align: "center",
  gradient: ['red', 'magenta']
});
...
const authorname = "Agatha MD"
const packname = "Criador: @"

const chyt = "553898291483@s.whatsapp.net";
const nit = "553898291483@s.whatsapp.net";
const supre = "5598291483@s.whatsapp.net";
